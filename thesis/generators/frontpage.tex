...
\HRule \\[0.5cm]
\begin{Huge}
	\bfseries{Semantically Aggregated Ensemble Visualization In Meteorology}\\[0.7cm] % Title of your document
\end{Huge}
\HRule \\[0.5cm]
...
\large \emph{Author:} Kaspar Tvedt Moberg\\
\large \emph{Supervisors:} Helwig Hauser\\[2cm]
